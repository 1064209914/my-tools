...
public class ExcelUtil {
	...
	public static void createXSSFCell(XSSFWorkbook wb, XSSFRow row, int column, String value, Font font) {
	...
	public static void main(String[] args) {
		...
		String src_xlspath = "C:\\Users\\Administrator\\Documents\\WeChat Files\\huxiaodong1064209914\\Files\\录音地址.xlsx";
		...
		for (int i = 1; i < rowList.size(); i++) {
			...
			System.out.println(getCellValue(obj.getCell(1)) + "|" + getCellValue(obj.getCell(3)));
		}
