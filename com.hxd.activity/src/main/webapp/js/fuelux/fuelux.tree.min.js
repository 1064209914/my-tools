(function(a, c) {
	var b = function(e, d) {
		...
		this.$element.on("click", ".tree-folder-header", a.proxy(function(event) {
			(this.options.selectHeader)&&this.options.selectHeader(event);
		}, this));
		this.render();
	};
	b.prototype = {
		...
		selectFolder: function(e) {
			var d = a(e).closest('.tree-folder-header');
			var f = d.parent();
