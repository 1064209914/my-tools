...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var $ok = $("<a>").addClass("sgBtn").addClass("ok").attr({"id":"sgBtnOk"}).text("确定");//确定按钮
		var $cancel = $("<a>").addClass("sgBtn").addClass("cancel").text("取消");//取消按钮
		var $input = $("<input>").addClass("inputBox");//输入框
		var $clsBtn = $("<a>").addClass("close").append("<span aria-hidden='true'>&times;</span>");//关闭按钮
		...
		if($(".xcConfirm").attr("id")!=undefined){
			$(".xcConfirm").remove();
		}
		init();
